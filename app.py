...
<div class="main-header">
    ...
    <p>Tác giả: Bùi Thị Thủy - Trường Tiểu học Đông An - ĐT: 038 7913 365</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bùi Thị Thủy - Trường Tiểu học Đông An - ĐT: 038 7913 365</div>", unsafe_allow_html=True)
